                ...
                <div className="flex flex-col justify-between flex-1 relative z-10">
                  ...
                  <div className="mt-4 flex gap-2 flex-wrap">
                    ...
                    {status === "outbid" && (
                      <button
                        onClick={() => navigate(`/auctions/${auction.id}`)}
                        className="px-4 py-2 text-sm rounded-lg bg-gradient-to-r from-red-500 to-red-600 text-white hover:opacity-90 transition"
                      >
                        💰 Bid Again
                      </button>
                    )}
                    ...
                    {status === "won" && (
                      <button
                        ...
                        className="px-4 py-2 text-sm rounded-lg bg-gradient-to-r from-green-500 to-green-600 text-white hover:opacity-90 transition"
                      >
                        💳 Pay Now
                      </button>
                    )}
